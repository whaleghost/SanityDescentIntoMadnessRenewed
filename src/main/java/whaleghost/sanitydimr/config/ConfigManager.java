package whaleghost.sanitydimr.config;
...
public abstract class ConfigManager
{
    ...
    public static void init()
    {
        ...
        proxies.put("sanity.passive.garland", new ProxyValueEntry<>(() -> getDefault().m_garland.get(), ConfigManager::finalizePassive));
    ...
    {
        ModLoadingContext.get().getActiveContainer().registerConfig(ModConfig.Type.COMMON, def.getRight());
    }
